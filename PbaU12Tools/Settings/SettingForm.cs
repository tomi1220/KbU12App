...
namespace PbaU12Tools.Settings
{
    public partial class SettingForm : Form
    {
        ...
        private void loadVenueDatas()
        {
            try
            {
                VenueDatas? venueDatas = deserializeVenueDatas();
        ...
        private VenueDatas? deserializeVenueDatas(string? venueDataFilePath = null)
        {
        ...
        private void importVenueData()
        {
            ...
            VenueDatas? venueDatas = deserializeVenueDatas(ofd.FileName);
