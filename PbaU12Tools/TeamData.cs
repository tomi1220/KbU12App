...
namespace PbaU12Tools
{
    ...
    {
        public List<TeamInfo> CreateDefaultBoysTeamList()
        {
            List<TeamInfo> teamInfosB = new List<TeamInfo>();
            teamInfosB.AddRange(
                new TeamInfo[]
                {
                    new TeamInfo()
                    {
                        ...
                        JbaTeamRegistrationStatus = true
                    },
                    new TeamInfo()
                    {
        ...
        public List<TeamInfo> CreateDefaultGirlsTeamList()
        {
            List<TeamInfo> teamInfosG = new List<TeamInfo>();
            teamInfosG.AddRange(
                new TeamInfo[]
                {
                    new TeamInfo()
